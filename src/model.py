...
def load_model(weights_path, model):
    ...
    try:
        ...
        print(f'Error occured during model loading!')
...
"""
The models below are developed by MinivisionAi for the face anti spoofing solution. The original code can be found here https://github.com/minivision-ai/Silent-Face-Anti-Spoofing/tree/master
"""
